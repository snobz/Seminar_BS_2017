...
WIP: Christoph
FreeRTOS wird seit etwa 10 Jahren von der Firma Real Time Engineers Ltd. in Zusammenarbeit mit verschiedenen Chipherstellern entwickelt. Derzeit unterstützt es 35 Architekturen und wurde mehr als 113000 mal heruntergeladen. Die Entwickler konzentrieren sich bei der Entwicklung darauf sowohl ein geeignetes Qualitätsmanagement umzusetzen, als auch die Verfügbarkeit der verschiedenen Dateiversionen zu gewährleisten. Darüber hinaus wird FreeRTOS in zwei verschiedenen Lizenzmodellen angeboten, die eine Anpassung der origi nären GNU General Public Licence darstellen. Die Open Source Lizenz erhält keine Garantieunterstützung, keinen Support und Entwickler, die diese Lizenz verwenden müssen ihren Quellcode offenlegen. In der kommerziellen Variante kann selbst entwickelter Code als closed source vertreiben werden. Ebenso unterstützt Real Time Engineers Ltd. bei der Entwicklung und bietet eine Garantie FreeRTOS.
