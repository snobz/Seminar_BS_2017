...
%Ein ungewollter Speicherzugriff ist somit durchaus möglich. Durch die Umschreibung des vorherhigen Satzes jetzt doppelt.
\newline
...
\begin{itemize}
	...
	%Ich habe versucht die Aufzählung etwas zu vereinheitlichen. Ggf. muss du noch etwas nachsteuern
\end{itemize}
...
\begin{figure}[htb]
	...
	\caption{Zugriffsrechte für eine Restricted Task werden durch den RTOS Kernel in der MPU konfiguriert. Der Speicherzugriff wird automatisch durch MPU/ MMU überprüft und im Fehlerfall an den Kernel gemeldet. Bild-Quelle~\protect\citeA{RTOSRevealed}}
