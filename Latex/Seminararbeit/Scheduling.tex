...
Bei harten Echtzeitanforderungen hängt dies stark vom Kontext der Zielanwendung ab. In harten Echtzeitsystemen ist die Performance des Schedulers (Ein/Auslagern einer Task) und der API Funktionen ebenfalls zu berücksichtigen, diese werde aber von Real Time Engineers nicht veröffentlicht. Um zu gewährleisten, dass ein Echtzeitanwendung die auf FreeRTOS aufsetzt, harten Echtzeitanforderungen genügt, wird die Echtzeitfähigkeit durch Echtzeit Performance Messungen bestimmt\cite{RealTimePerformance}.  
