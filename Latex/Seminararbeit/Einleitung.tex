...
% Hier hattest du gesagt das wäre ein direktes Zitat. Das müssen wir dann entsprechend kennzeichnen und die Quelle angeben.
...
%Wie sichergestellt werden kann, dass ein Task harten oder weichen Echtzeitanforderungen entspricht, wird Abschnitt \ref{sec:Echtzeitanalyse} beschrieben. 
...
%Der ursprüngliche Satz passte hier nicht so richtig, schau mal, ob das so besser passt
