...
//#include "SEGGER_SYSVIEW_FreeRTOS.c"        // MOD_SEGGER
//#include "SEGGER_SYSVIEW.h"                 // MOD_SEGGER
//#include "SEGGER_SYSVIEW.c"                 // MOD_SEGGER
//#include "SEGGER_RTT.h"                     // MOD_SEGGER
#include "FreeRTOS.h"
#include "task.h"
#include "timers.h"
...
//MY Function
BaseType_t get_xSchedulerRunning() {
    return xSchedulerRunning;
}

UBaseType_t getCurrentTaskId(void) {
